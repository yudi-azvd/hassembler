...
std::vector<std::string> Scanner::parseTokens(const std::string line) {
  int newStart = 0;
  int tokenStartsAt = 0;
  std::string token = "";
...
std::string Scanner::findNextTokenStartingFrom(
  size_t start,
  std::string line,
  int& tokenStartsAt
) {
...
bool Scanner::isValidSymbol(std::string symbol) {
